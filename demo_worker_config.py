...
def interactive_demo():
    ...
    hyperparam_opt = input(f"Select hyperparam optimizer ({'/'.join(hyperparam_opts)}): ").lower()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--show-configs", action="store_true", help="Show example configurations")
