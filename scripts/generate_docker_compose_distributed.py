...
def main():
    parser = argparse.ArgumentParser(description='Generate distributed workers docker-compose override')
    ...
    parser.add_argument('--output', type=str, default='docker-compose.override.yml', help='Output file')
