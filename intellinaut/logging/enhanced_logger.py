...
class DistributedLogger:
    ...
    def _setup_log_files(self):
        ...
        # Structured JSON log
        self.json_log_file = (
            self.shared_dir / "structured" / f"{component_id}_{timestamp}.jsonl"
        )
        ...
        self.perf_log_file = (
            self.shared_dir
            / "performance"
            / f"{component_id}_performance_{timestamp}.jsonl"
        )
    ...
    def _create_log_entry(
        ...
        **kwargs,
        ...
        if (
            ...
            and time.time() - self.last_performance_log > self.performance_interval
        ):
